...
},{"./typescript_to_zig.js":2}],2:[function(require,module,exports){
...
function peg$parse(input, options) {
  ...
  var peg$c24 = function(name, type_params, b, t1, c) {
  		return function(name1){return "fn "+name+"(arguments:anytype) "+t1+"{"+b+c+"}";}
  		if(type_params.length > 0){
  			return "fn "+name+"("+type_params[2]+",arguments:anytype) "+t1+"{"+b+c+"}";
  		}
  		else{
  ...
  var peg$c166 = function(a) {expression_types[a] = "float"; return "["+a+"]";};
  ...
  var peg$c179 = function(a2) {return ".{"+a2[1]+"}";};
  ...
  var peg$c187 = function(a1, t1) {return ["var "+a1+":"+t1];};
  var peg$c188 = function(a1) {return ["var "+a1];};
  var peg$c189 = function(head, tail) {
        return (tail.reduce(function(result, element) {
          return result.concat(element[3]);
        }, head)).map(function(value,index){return value+"=arguments["+index+"];";}).join("");
      };
  var peg$c190 = function(head, tail) {
  ...
  var peg$c193 = "elseif";
  var peg$c194 = peg$literalExpectation("elseif", false);
  var peg$c195 = function(a2) {return "else {"+a2+"}";};
  var peg$c196 = function(a1, a3, a5) {return "else if("+a3+"){"+a5+"}";};
  var peg$c197 = function(a1) {if(a1 == "this") return "self"; else if(a1 === "true" || a1 === "false") return a1; else return "compiled_"+a1;};
  var peg$c198 = function(a2) {return a2;};
  var peg$c199 = function(a1) {return a1+";";};
  var peg$c200 = /^[a-zA-Z_]/;
  var peg$c201 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false);
  var peg$c202 = /^[a-zA-Z0-9_]/;
  var peg$c203 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false);
  var peg$c204 = function() {return text();};
  var peg$c205 = "\"";
  var peg$c206 = peg$literalExpectation("\"", false);
  var peg$c207 = /^[^"\\]/;
  var peg$c208 = peg$classExpectation(["\"", "\\"], true, false);
  var peg$c209 = "\\";
  var peg$c210 = peg$literalExpectation("\\", false);
  var peg$c211 = peg$anyExpectation();
  var peg$c212 = function(a, b) {return "@as(f64,"+a+"."+b+")";};
  var peg$c213 = function(a) {return a;};
  var peg$c214 = peg$otherExpectation("integer");
  var peg$c215 = /^[0-9]/;
  var peg$c216 = peg$classExpectation([["0", "9"]], false, false);
  var peg$c217 = function() { return text(); };
  var peg$c218 = /^[ \t\n\r]/;
  var peg$c219 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false);
